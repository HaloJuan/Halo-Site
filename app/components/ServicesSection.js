      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Think of us as personal trainers for your business data. We understand that every business is 
            unique which is why our specialised dashboard solutions are tailored to your specific
            challenges. And like a personal trainer - we're your partners in growth. We'll equip you with 
            the right tools helping you build the confidence and skill to navigate your data and 
            uncover insights, empowering you to make data-driven decisions with ease.
          </p>
        </div>
